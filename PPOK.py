...
# Konfigurasi halaman
st.set_page_config(page_title="Diagnosis PPOK", page_icon="🫁", layout="wide")
...
'>
    ...
    <div>
        ...
        <p style='margin-top: 5px; font-size: 16px; color: #333;'>Berbasis Dempster-Shafer • Akurat • Informatif</p>
    </div>
</div>
...
if process_button:
    ...
    if not nama or umur == 0:
        ...
        st.metric("🫁 Keyakinan PPOK", f"{belief_ppok * 100:.2f}%")
